    ...
    <>
      ...
      <div className="mx-auto max-w-5xl space-y-8 px-4 pt-8">
        ...
        {!isConfigured ? (
          ...
          <div className="glass-card flex min-h-[200px] items-center justify-center">
            <p className="text-muted-foreground">Menunggu sinkronisasi data terstruktur</p>
          </div>
        ) : (
          <>
            {switches.length > 0 && (
              <section>
                <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">Switch</h2>
            ...
            {dimmers.length > 0 && (
              <section>
                <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">Dimmer</h2>
                <div className="flex flex-wrap gap-4">
            ...
            {sensors.length > 0 && (
              <section>
                <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-muted-foreground">Sensor</h2>
                <div className="flex flex-wrap gap-4">
